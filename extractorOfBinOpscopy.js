            ...
            enter:function(node, parent) {
                ...
                if (node.type === "BinaryExpression") {
                    ...
                    if (typeof leftName !== "undefined" && typeof rightName !== "undefined") {
                        ...
                        const parsedTree = esprima.parse(buggySurroundingStatementOperator);
                        const leafNodes = [];
                        ...
                        const parsedTreeNonBuggy = esprima.parse(buggySurroundingStatementOperator);
